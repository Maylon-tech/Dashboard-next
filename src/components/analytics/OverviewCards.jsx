...
const overviewData = [
    { name: "Revenue", value: "$1.546.443", change: 12.5, icon: DollarSign },
    { name: "Users", value: "$45.678", change: 8.3, icon: Users },
    { name: "Orders", value: "$9.876", change: -3.2, icon: ShoppingBag },
    { name: "Page Views", value: "$1.546.889", change: 15.7, icon: Eye },
]
        ...
        overviewData.map((item, index) => (
            ...
            >
                ...
                <div className={`mt-4 flex items-center ${item.change >= 0 ? "text-green-500" : "text-red-500"}`}>
                    ...
                    <span className="ml-1 text-sm text-gray-400">{Math.abs(item.change)}%</span>
