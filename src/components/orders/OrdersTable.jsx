...
const ORDER_DATA = [
    ...
    { id: "ORD002", customer: "Jane Smith", total: "423.0", status: "Processing", date: "2023-07-02" },
...
const OrdersTable = () => {
    ...
    const handleSearch = (e) => {
        ...
        setSearchTerm(term)
        const filtered = ORDER_DATA.filter( (order) => order.name.toLowerCase().includes(term) || order.customer.toLowerCase().includes(term))
